...
function displayConfirmNotification() {
    if('serviceWorker' in navigator) {
        let options = { 
            ...
            //badge: './images/icons/ios-mcl76x76.png', // falls nict genug desplay Platz da ist
            ...
            actions: [
                { action: 'confirm', title: 'Ok', /* icon: './images/icons/ios-mcl76x76.png' */ },
                { action: 'cancel', title: 'Cancel', /* icon: './images/icons/ios-mcl76x76.png' */ },
            ]
        }
